...
- [List Contributors By Commit Count](git/list-contributors-by-commit-count.md)
- [Search Commit Message](git/search-commit-message.md)
- [Show Last Commit Differences](git/show-last-commit-differences.md)

### Linux

- [Activate Hot-Added vCPU](linux/activate-hot-added-vcpu.md)
- [Detect New Attached Hard Disk](linux/detect-new-attached-hard-disk.md)
...
- [Prevent Accidental Shutdowns and Reboots](linux/prevent-accidental-shutdowns-reboots.md)
- [Protect A File From Modification](linux/protect-a-file-from-modification.md)
- [Safely Run iptables Script](linux/safely-run-iptables-script.md)
- [Set Hot-Added Memory Online](linux/set-hot-added-memory-online.md)
- [Show Largest Installed Packages](linux/show-largest-installed-packages.md)
...
- [Remotely Restart a Service](powershell/remotely-restart-service.md)
...
- [Check OS Version](unix/check-os-version.md)
...
- [Create File With head](unix/create-file-with-head.md)
- [Dot Command](unix/dot-command.md)
- [Edit Piped Data](unix/edit-piped-data.md)
- [Execute And Get Next](unix/execute-and-get-next.md)
...
- [grep Include Adjacent Lines](unix/grep-include-adjacent-lines.md)
- [grep UTF-16](unix/grep-utf16.md)
- [grep Whole Words](unix/grep-whole-words.md)
...
- [less Invoke Editor](unix/less-invoke-editor.md)
- [less Simulate tail -f](unix/less-simulate-tail-f.md)
...
- [sudo Preserve Environment](unix/sudo-preserve-environment.md)
...
- [Replace Tabs with Spaces](vim/replace-tabs-with-spaces.md)
